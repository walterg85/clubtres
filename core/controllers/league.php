        ...
        if($is_jwt_valid){
            ...
            if($_POST['_method'] == 'POST'){
                ...
                if($tmpResponse[0]){
                    ...
                    if (!empty($_FILES['bannerleague'])){
                        $filename = $_FILES['bannerleague']['name'];
                        $tempname = $_FILES['bannerleague']['tmp_name'];    
                ...
                header("Content-Type: application/json; charset=UTF-8");
                exit(json_encode($response));
            }else if($_POST['_method'] == 'updateEvent'){
                $leagueModel = new Leaguemodel();
                $tmpResponse = $leagueModel->updateEvent($_POST);
                ...
                header("Content-Type: application/json; charset=UTF-8");                
                exit(json_encode($response));
            }else if($_POST['_method'] == 'updateEvent2'){
                $leagueModel = new Leaguemodel();
                $tmpResponse = $leagueModel->updateEvent2($_POST);
